...
//核心类，对Clock设置提供支持信息
public class Alarms {
    public static final String ALARM_ALERT_ACTION = "com.example.clock.ALARM_ALERT";
    public static final String ALARM_DONE_ACTION = "com.example.clock.ALARM_DONE";
    public static final String ALARM_SNOOZE_ACTION = "com.example.clock.ALARM_SNOOZE";
    public static final String ALARM_DISMISS_ACTION = "com.example.clock.ALARM_DISMISS";
            ...
            if (cursor.moveToFirst()) {
                do {
                    ...
                    if (a.time == 0) {
                        ...
                        Log.v("guo", "Disabling expired alarm set for ");
    ...
    private static void enableAlert(Context context, final Alarm alarm,
        ...
        if (true) {
            Log.v("guo", "** setAlert id " + alarm.id + " atTime " + atTimeInMillis);
        }
