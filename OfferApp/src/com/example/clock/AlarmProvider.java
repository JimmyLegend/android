...
public class AlarmProvider extends ContentProvider {
    ...
    static {
        sURLMatcher.addURI("com.example.clock", "alarm", ALARMS);
        sURLMatcher.addURI("com.example.clock", "alarm/#", ALARMS_ID);
    }
...
//存取闹钟的数据库，有初始的闹钟以及对闹钟的增删改操作
    ...
    public Cursor query(Uri url, String[] projectionIn, String selection,
        ...
        if (ret == null) {
            if (true) Log.v("guo", "Alarms.query: failed");
        } else {
    ...
    public int update(Uri url, ContentValues values, String where, String[] whereArgs) {
        ...
        Log.v("guo", "*** notifyChange() rowId: " + rowId + " url " + url);
    ...
    public Uri insert(Uri url, ContentValues initialValues) {
        ...
        Log.v("guo", "Added alarm rowId = " + rowId);
